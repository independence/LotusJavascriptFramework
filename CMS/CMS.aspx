<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CMS.aspx.cs" Inherits="CMS.CMS" %>
...
<head runat="server">
 ...
 <%--   <link rel="stylesheet" href="/CSS/style.css" />--%>
    ...
    <script src="/JS/ForEachPage/Process_SystemUsers.js" type="text/javascript"></script>

    <script type="text/javascript">
        jQuery(document).ready(function () {
            Init_System_CMS();
            Module_CurrentUser("#divCurrentUser");

            InitMenu("#divMenuLevel1", "#divMenuLevel2");
        });
    </script>

    <%-- 
    <script src="JS/FRAMEWORK/BussinessLogic/CategoryLevel1BO.js" type="text/javascript"></script>
    <script src="JS/FRAMEWORK/BussinessLogic/ContentsBO.js" type="text/javascript"></script>
    <script src="JS/ForEachPage/Process_Default_Page.js" type="text/javascript"></script>--%>
    <%--================================================================================================================--%>
...
<body>
    ...
    <div id="PositionLoading" style="" title="xxxx">
    </div>
    <div id="PositionConfigs">
       <input type="hidden" id="txtNumLang" name="txtNumLang" runat="server" clientidmode="Static" />
       <input type="hidden" id="txtCurrentUser" name="txtCurrentUser" runat="server" clientidmode="Static" />
       <input type="hidden" id="txtCurLang" name="txtCurLang" runat="server" clientidmode="Static" />
       <input type="hidden" id="txtDefLang" name="txtDefLang" runat="server" clientidmode="Static" />
       <input type="hidden" id="txtList_IDLang" name="txtList_IDLang" runat="server" clientidmode="Static" />

       <input type="hidden" id="txtLANG_DATA_MASTER" name="txtLANG_DATA_MASTER" runat="server" clientidmode="Static" />
       <input type="hidden" id="txtLANG_DATA" runat="server" clientidmode="Static" />
       <%--<div id="Lang" clientidmode="Static" runat="server"> </div>--%>
        ...
        <div class="secNav">
            <div class="secWrapper">
                <div class="secTop">
                 ...
                 <div  class="tab-container"  id="divMenuLevel2" style="display:none">
    ...
    <div id="content">
        ...
        <div class="wrapper">
            <form id="form1" runat="server">
                <div style="padding-top:30px;" id="MainContent">
