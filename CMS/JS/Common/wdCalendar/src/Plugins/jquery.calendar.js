...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        var def = {
             ...
             */
            quickDeleteUrl: "xxxxxxxssssssss", 
            /**
        ...
        function quickd(type) {
            ...
            $.post(option.quickDeleteUrl, param, function(data) {
                if (data) {
                    ...
                    if (data.IsSuccess || data.status == "success") { //Da sua lai cho phu hop voi cach code cua NgocBM 
                        de = null;
        ...
        function dayshow(e, data) {
            ...
            // data[8] : Cho phép kéo thả 

                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
             
                    //var Info = "Sự kiện: "+ data[1]+"<br/> Tại : "+ data[4] + "<br/> Từ :"+ dateFormat.call(data[2], i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm")+" <br/> Đến: "+  dateFormat.call(data[3], i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm");
                    var Info = "Sự kiện: "+ data[1]+"<br/> Từ :"+ dateFormat.call(data[2], i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm")+" <br/> Đến: "+  dateFormat.call(data[3], i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm");
                    ...
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
                    	...
                    	+ i18n.xgcalendar.click_to_detail + '" class="textbox-fill-div lk" style="cursor:pointer;"></div></div></div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-timeshow"></div></td></tr></tbody></table><div class="bbit-cs-split"><input id="bbit-cs-id" type="hidden" value=""/><input type="button" id="bbit-cs-delete" class="lk" value="Xóa"/> <input type="button" id="bbit-cs-editLink" class="lk" value="Sửa thông tin"/>';
                    	csbuddle = csbuddle + ' </div></div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose2" class="bubble-closebutton"></div><div id="prong1" class="prong"><div class=bubble-sprite></div></div></div>';
...
//                temparr.push(i18n.xgcalendar.example, '</div></td></tr></tbody></table><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><input id="btnAdd" value="NewAdd" type="button" /> <input id="bbit-cal-quickAddBTN" value="');
...
//      temparr.push('<div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div></td><td class="bubble-cell-main">');
//      temparr.push('<div class="bubble-top"></div></td><td class="bubble-cell-side"><div id="tr1" class="bubble-corner">');
//      temparr.push('<div class="bubble-sprite bubble-tr"></div></div></td></tr><tr><td class="bubble-mid" colspan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellspacing="0" cellpadding="0"><tbody><tr><th class="cb-key">Xin chào</th><td class="cb-value"><div id="bbit-cal-buddle-timeshow"></div></td></tr><tr><th class="cb-key">Bạn có thể tạo hoặc sửa đặt phòng/hội trường bằng cách ấn vào nút dưới đây</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid">Sau khi tạo bạn cần refresh lại trình duyệt để thông tin được hiển thị</div><div class="cb-example">Thanks</div></td></tr></tbody></table><input id="bbit-cal-start" type="hidden" /><input id="bbit-cal-end" type="hidden" /><input id="bbit-cal-allday" type="hidden" /><input id="btnAdd" value="NewAdd" type="button" /><input id="bbit-cal-quickAddBTN" value="Đặt phòng" type="button" style="display: none" /><input type="button" id="bbit-cal-editLink" class="lk" value="Sửa thông tin" /></div></div></div></td><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div></td><td><div class="bubble-bottom"></div></td></tr><tr><td colspan="3"><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></td></tr></tbody></table><div id="bubbleClose1" class="bubble-closebutton"></div><div id="prong2" class="prong"><div class="bubble-sprite"></div></div></div>');
//      var tempquickAddHanler = temparr.join("");

    temparr.push ('<div id="bbit-cal-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><th class="cb-key"></th><td class=cb-value><div id="bbit-cal-buddle-timeshow"></div></td></tr><tr><th class="cb-key">Chào bạn,</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid">Bạn có thể đặt/sửa lịch phòng bằng các nút dưới đây.</div></div><div class="cb-example">Bạn cần refresh lại trình duyệt để hiển cập nhật lại trạng thái</div></td></tr></tbody></table><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><input id="btnAdd" value="Đặt phòng" type="button" /> <input id="bbit-cal-quickAddBTN" value="Đặt phòng" type="button" style="display:none"/>&nbsp; <input id="bbit-cal-editLink"  type="button" value="Sửa thông tin1" style="display:none"/></div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose1" class="bubble-closebutton"></div><div id="prong2" class="prong"><div class=bubble-sprite></div></div></div>');
            ...
            //================
                ...
                $('#btnAdd').attr('onclick','').unbind('click');
                var btnAdd = $("#btnAdd").click(function() {
                    // ChangeFormatDateTime : Common.js
                    option.onClick_BtnAdd(ChangeFormatDateTime(datestart), ChangeFormatDateTime(dateend), allday, "Booking");
                    $("#bbit-cal-buddle").css("visibility", "hidden");
