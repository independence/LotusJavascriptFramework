...
function ShowMessageBox(msg, title, width) {
    ...
    if ($("#PositionShowDialog").length <= 0) {
        $("body").append('<div id="PositionShowDialog" style="display:none;" title="' + title + '"><br /><span style="float:left; margin-right:10px;"><img src="/Skins/Images/popup_logo.jpg" alt="logo" width=\'66\' /></span><div class="popup_message"></div></div>');
    }

    $("#PositionShowDialog").html(msg);
