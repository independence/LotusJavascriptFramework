...
{
    preloader.active(true);
   // style = "opacity: 0.2; position: absolute; border: 1px solid rgb(170, 170, 170); border-radius: 14px; height: 154px; width: 154px; transform: translate(-50%, -50%) matrix(1, 0, 0, 1, 0, 0); background-color: white;"
}
