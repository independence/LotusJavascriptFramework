/**
 * @package Ga Articles Slideshow Module for Joomla! 2.5
 * @author http://www.gatheme.com
 * @copyright (C) 2011- GaTheme.com
 * @license PHP files are GNU/GPL
**/
if(typeof(GaSlideshow) == 'undefined'){
  var GaSlideshow = new Class({
    initialize:function(_gamain, options){
      this.setting = $extend({
        autoStart     : false,
        descStyle       : 'sliding',
        mainItemSelector    : 'div.ga-main-item',
        navSelector     : 'li' ,
      ...
      var eMain      = _gamain.getElement('.ga-main-wapper');
      var eNavigator = _gamain.getElement('.ga-navigator-outer .ga-navigator');
      var eNavOuter  = _gamain.getElement('.ga-navigator-outer');   
      this.currentNo  = 0;
      this.nextNo     = null;
      ...
      if($defined(eNavigator) && $defined(eNavOuter)){
        ...
        if($defined(_gamain.getElement(".ga-bullets"))){
