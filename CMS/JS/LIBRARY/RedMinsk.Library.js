...
function showMessageBox(msg, title, width) {
    ...
    if ($("#RM_MessageBox").length <= 0) {
        $("body").append('<div id="RM_MessageBox" style="display:none;" title="' + title + '"><br /><span style="float:left; margin-right:10px;"><img src="/Images/popup_logo.png" alt="logo" width=\'66\' /></span><div class="popup_message"></div></div>');
    }
