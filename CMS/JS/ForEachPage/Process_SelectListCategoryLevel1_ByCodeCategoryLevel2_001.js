...
/*======================================================================================*/
function FillCategoryLevel2DataToDropdowList_EditForm(div, FocusCodeCategoryLevel2) {
    ...
    jQuery.ajax({
        ...
        success: function (data, dataStatus) {
            if (data.CategoryLevel2_Group.length >= 1) {
                ...
                $(data.CategoryLevel2_Group).each(function (i, item) {
                    if (item.Code == FocusCodeCategoryLevel2) {
...
function OpenDialog_Ins_CategoryLevel1() {
    ...
    $("#PositionShowDialog").setTemplateURL('../../Templates/Ins_CategoryLevel1ToCategoryLevel2_001.htm');
    ...
    if (IDCategoryLevel1 > 0) {
        jQuery.ajax({
            ...
            success: function (data, dataStatus) {
                ...
                $("#PositionShowDialog").setTemplateURL('../../Templates/Upd_CategoryLevel1ToCategoryLevel2_001.htm');
                $("#PositionShowDialog").setParam('NumLang', sys_NumLang); //sys_NumLang : trong file SystemConfig.js
                $("#PositionShowDialog").setParam('Lang', sys_Lang);
