...
function OpenDialog_Ins_Contents(CodeCategoryLevel1) {
    ...
    $("#PositionShowDialog").setTemplateURL('../../Templates/Ins_ContentToCategoryLevel1_005.htm');
    ...
    if (IDContents > 0) {
        jQuery.ajax({
            ...
            success: function (data, dataStatus) {
                ...
                $("#PositionShowDialog").setTemplateURL('../../Templates/Upd_ContentToCategoryLevel1_005.htm');
                $("#PositionShowDialog").setParam('NumLang', sys_NumLang); //sys_NumLang : trong file SystemConfig.js
                $("#PositionShowDialog").setParam('Lang', sys_Lang);
