function Init_Dialog_Ins(divCategoryLevel2, divAlbums) {
    ...
    FillCategoryLevel2DataToDropdowList(divCategoryLevel2);
    
    
}


function Init_Dialog_Upd(divCategoryLevel2, divAlbums, divCodeCategoryLevel2, divIDAlbums) {
    setTimeout('$("#tabs").tabs();', 1000);
    setTimeout('Change_Multi_TextareaToTinyMCE(".txt_Info");', 2000);
    var CodeCategoryLevel2 = $(divCodeCategoryLevel2).val();
    var IDAlbums = $(divIDAlbums).val();

    FillCategoryLevel2DataToDropdowList_EditForm(divCategoryLevel2, CodeCategoryLevel2);
