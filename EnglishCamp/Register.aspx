<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="EnglishCamp.Register" %>
...
<head>
    ...
    <script src="JS/ForEachPage/Process_Register.js"></script>
            ...
            <div class="content_middle">
                <div class="contents fl">
                    <div class="content_tab" id="lien-he">
                        ...
                        <p>Nếu Quý khách muốn đăng kí học hoặc có bất kỳ câu hỏi, đề nghị hoặc nhận xét nào, xin vui lòng liên hệ với chúng tôi theo thông tin dưới đây:</p>
                        <h2>Tư vấn trực tiếp</h2>
