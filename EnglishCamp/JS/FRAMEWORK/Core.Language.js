...
function sys_LoadStaticDataLanguage() {
    ...
    jQuery.ajax({
        url: "/Action/ProcessFrontendAction.ashx?ActionObject=CORE&action=STATIC_DATA_LANGUAGE",
        type: "POST",
        dataType: "json",
        data: "",
...
function sys_LoadDynamicDataLanguage(FileName) {
    ...
    jQuery.ajax({
        url: "/Action/ProcessFrontendAction.ashx?ActionObject=CORE&action=DYNAMIC_DATA_LANGUAGE&filename=" + FileName,
        type: "POST",
        dataType: "json",
        data: "",
        success: function (data, dataStatus) {
